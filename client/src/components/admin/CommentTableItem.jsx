...
const CommentTableItem = ({comment, fetchComments}) => {
    ...
    const deleteComment = async () => {
        try {
            ...
            const confirm = window.confirm('Are you sure you want to this delete this comment?');
            if(!confirm) return;
     ...
     <tr className='order-y border-gray-300'>
        ...
        <td className='px-6 py-4'>
            <div className='inline-flex items-center gap-4'>
                ...
                :
                <p className='text-xs border border-green-600 bg-grwwn-100 text-green-600 rounded-full px-3 py-1'>Approved</p>
                }
